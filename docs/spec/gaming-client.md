...
1. En la `/` (LandingView), se agrega un _Call to Action_ primario: "Jugar ahora".
2. Se muestra una sección con 2-3 _flashcards_ estáticas/hardcodeadas para ilustrar la mecánica de giro (flip) y despertar el interés del usuario.
...
4. **Botón de Micrófono (Pronunciation)**:
...
5. **Repetir Fallidas en Frontend**:
