...
- [ ] **TASK-PROGRESS-PRE-01** — Mover `AmqpMessageBus` al `SharedModule`
...
- [ ] **TASK-PROGRESS-PRE-02** — Cablear `GamingModule` a AMQP real
...
- [ ] **TASK-PROGRESS-PRE-03** — Cablear `IdentityModule` a AMQP real
...
- [ ] **TASK-PROGRESS-01** — Value Objects
...
- [ ] **TASK-PROGRESS-02** — Domain Exceptions
...
- [ ] **TASK-PROGRESS-03** — Domain Event `ModuleLevelUpEvent`
...
- [ ] **TASK-PROGRESS-04** — Read Model `ModuleProgress`
...
- [ ] **TASK-PROGRESS-05** — Aggregate `UserFlashcardStats`
...
- [ ] **TASK-PROGRESS-06** — Interfaces de repositorio
...
- [ ] **TASK-PROGRESS-07** — `GetModulesProgressUseCase`
  - Input: `{ userId: string }`.
...
- [ ] **TASK-PROGRESS-08** — `GetWeakestFlashcardsUseCase`
...
- [ ] **TASK-PROGRESS-09** — `UpdateFlashcardStatsOnAttemptRecorded`
...
- [ ] **TASK-PROGRESS-10** — `UpdateModuleProgressOnGameCompleted`
...
- [ ] **TASK-PROGRESS-11** — `ImportGuestProgressOnGuestProgressMigrated`
...
- [ ] **TASK-PROGRESS-12** — Migración TypeORM: `module_progress`
...
- [ ] **TASK-PROGRESS-13** — Migración TypeORM: `processed_events`
...
- [ ] **TASK-PROGRESS-14** — TypeORM Entity `UserFlashcardStatsEntity`
...
- [ ] **TASK-PROGRESS-15** — TypeORM Entity `ModuleProgressEntity`
...
- [ ] **TASK-PROGRESS-16** — TypeORM Entity `ProcessedEventEntity`
  - Mapea tabla `processed_events`.
  - Archivo: `progress/infrastructure/persistence/typeorm/processed-event.entity.ts`.

- [ ] **TASK-PROGRESS-17** — Repositorio `TypeOrmUserFlashcardStatsRepository`
...
- [ ] **TASK-PROGRESS-18** — Repositorio `TypeOrmModuleProgressRepository`
...
- [ ] **TASK-PROGRESS-19** — Repositorio `TypeOrmProcessedEventsRepository`
...
- [ ] **TASK-PROGRESS-20** — Controllers `GetModulesProgressController` y `GetWeakestFlashcardsController`
...
- [ ] **TASK-PROGRESS-21** — `ProgressModule` NestJS
...
- [ ] **TASK-PROGRESS-22** — E2E: `UpdateFlashcardStats` flow completo
...
- [ ] **TASK-PROGRESS-23** — E2E: `UpdateModuleProgress` — nivel sube
...
- [ ] **TASK-PROGRESS-24** — E2E: idempotencia de handlers
