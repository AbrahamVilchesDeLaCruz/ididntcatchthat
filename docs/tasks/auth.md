...
- [x] **TASK-AUTH-01** — `UserContext` type en `shared/domain/user-context.ts`
  - Type con campos: `type`, `deviceId`, `fingerprint?`, `ip`, `userId?`, `email?`, `roles?`

- [x] **TASK-AUTH-02** — Mothers base en `test/shared/domain/`
...
- [x] **TASK-AUTH-03** — Strategies y Guards en `shared/infrastructure/auth/`
...
- [x] **TASK-AUTH-18** — `GoogleOAuthHandler`
...
- [x] **TASK-AUTH-19** — `GuestProgressMigrator`
...
- [x] **TASK-AUTH-22** — `TypeOrmUserRepository`
...
- [x] **TASK-AUTH-25** — Controllers (uno por acción)
...
- [x] **TASK-AUTH-30** — E2E: refresh + logout
...
- [x] Todos los tests unit e integration pasan: `pnpm --filter @ididntcatchthat/api test`
- [x] Tests E2E pasan: `pnpm --filter @ididntcatchthat/api test:e2e`
- [ ] `pnpm lint` sin errores
- [x] Migración TypeORM ejecutable sin errores en DB de test
