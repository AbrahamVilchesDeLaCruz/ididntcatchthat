  ...
  return (
    <section className="px-5 py-20">
      <div className="mx-auto max-w-2xl">
        ...
        {/* Connected speech showcase */}
        <div className="mt-8 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-6">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-6">
            ...
            <span className="ml-auto rounded-full bg-[var(--color-accent-green-dim)] px-3 py-1 text-xs font-medium text-[var(--color-accent-green)]">
              {p.exampleTag}
            </span>
          </div>
        </div>
