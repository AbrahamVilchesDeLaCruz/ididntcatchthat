...
export const es: Translations = {
  ...
  study: {
    config: {
      title: 'Modo estudio',
      subtitle: 'Repasá sin presión. Escuchá, leé y avanzá a tu ritmo.',
      moduleLabel: 'Módulo',
      subcategoryLabel: 'Alcance',
      wholeCategory: 'Toda la categoría',
      countLabel: 'Cartas',
      ...
      pausedSaved: 'Sesión guardada. Podés retomarla cuando quieras.',
    },
    play: {
      next: 'Siguiente',
      sessionLabel: 'Repaso',
      ...
      tapNext: 'Tocá Siguiente para continuar',
